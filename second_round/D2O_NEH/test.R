...
Profile_Peptide2 <- function(I0_0 = 0.4581,I1_0 = 0.3416,  I2_0 = 0.1434, NEH = 23)
{
  ...
  for(i in 1:Nit)
  {
    ...
    format(print(c(I0[i], I1[i], I2[i], x[i], A, B, -B / A, NEH_Compute(I0[i],I1[i], I0_0,I1_0,pX = x[i] ))), digits=4);
...
Profile_Peptide3 <- function()
{
  ...
  for(i in 1:Nit)
  {
    ...
    I0[i] = I0_t(I0_0, x[i], NEH) +rnorm(1,0,0.005); #data$I0.11[i];#  I0_t(I0_0, x[i], NEH); #
    
    I1[i] = I1_t(I0_0, I1_0, NEH, x[i]) +rnorm(1,0,0.005); #data$I1.11[i];# I1_t(I0_0, I1_0, NEH, x[i]); #
    
    I2[i] = I2_t(I0_0, I1_0, I2_0, x[i], NEH) +rnorm(1,0,0.005); # data$I2.11[i];#I2_t(I0_0, I1_0, I2_0, x[i], NEH); # 
    ...
    format(print(c(I0[i], I1[i], I2[i], x[i], A, B, -B / A, NEH_Compute(I0[i],I1[i], I0_0,I1_0,pX = x[i] ),NEH)), digits=4);
    
    a[i] = A; b[i] = B;
    c_neh[i]=NEH_Compute(I0[i],I1[i], I0_0,I1_0,pX = x[i] );
  }
  ...
  df <- data.frame(a,b,x,t_neh,c_neh)
...
Profile_Peptide4 <- function() # theoretical
{
  ...
  for(i in 1:Nit)
  {
    ...
    for (j in 1:100)
    {
      ...
      I0[i*100+j] =data$I0.11[i];#  I0_t(I0_0, x[i*100+j], NEH); #I0_t(I0_0, x[i*100+j], NEH) +rnorm(1,0,0.005) ; # 
      
      I1[i*100+j] = data$I1.11[i];# I1_t(I0_0, I1_0, NEH, x[i*100+j]); #I1_t(I0_0, I1_0, NEH, x[i*100+j])+rnorm(1,0,0.005) ; #
      
      I2[i*100+j] =  data$I2.11[i];#I2_t(I0_0, I1_0, I2_0, x[i*100+j], NEH); #I2_t(I0_0, I1_0, I2_0, x[i*100+j], NEH)+rnorm(1,0,0.005); # 
...
Profile_Peptide5 <- function() # experimental
{
  ...
  for(i in 1:Nit)
  {
    ...
    I0_0 = data$I0.0[i];#data$M0[i]/100;# 
    
    I1_0 = data$I1.0[i];#data$M1[i]/100;#
    
    I2_0 = data$I2.0[i];#data$M2[i]/100;#
    
    
    
    I0[i] = data$I0.11[i];#I0_t(I0_0, x[i], NEH); # I0_t(I0_0, x[i], NEH) +rnorm(1,0,0.005); # 
    
    I1[i] = data$I1.11[i];#I1_t(I0_0, I1_0, NEH, x[i]); # I1_t(I0_0, I1_0, NEH, x[i]) +rnorm(1,0,0.005); #
    
    I2[i] = data$I2.11[i];#II2_t(I0_0, I1_0, I2_0, x[i], NEH); # 2_t(I0_0, I1_0, I2_0, x[i], NEH) +rnorm(1,0,0.005); # 
    
    
    
    I0_te[i] = I0_t(I0_0, x[i], NEH);
    I1_te[i] = I1_t(I0_0, I1_0, NEH, x[i]);
    I2_te[i] = I2_t(I0_0, I1_0, I2_0, x[i], NEH);
