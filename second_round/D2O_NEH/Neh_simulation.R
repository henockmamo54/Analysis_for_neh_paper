...
Profile_Peptide4 <- function() # theoretical
{
  ...
  for(i in 1:Nit)
  {
    ...
    for (j in 1:100)
    {
      ...
      x[i*100+j] = 0.0001 + j * 0.35 / 100;#0.046; #0.0001 + i * 0.35 / Nit;
      ...
      I0[i*100+j] = I0_t(I0_0, x[i*100+j], NEH) ; #data$I0.11[i];#  I0_t(I0_0, x[i], NEH); #
      
      I1[i*100+j] = I1_t(I0_0, I1_0, NEH, x[i*100+j]) ; #data$I1.11[i];# I1_t(I0_0, I1_0, NEH, x[i]); #
      
      I2[i*100+j] = I2_t(I0_0, I1_0, I2_0, x[i*100+j], NEH); # data$I2.11[i];#I2_t(I0_0, I1_0, I2_0, x[i], NEH); # 
