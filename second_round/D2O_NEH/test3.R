...
Profile_Peptide4 <- function() # theoretical
{
  ...
  for(i in 1:Nit)
  {
    ...
    for (j in 1:100)
    {
      ...
      x[i*100+j] =0.0001 + j * 0.1 / 100;# 0.046; #0.0001 + i * 0.35 / Nit;
      ...
      I0[i*100+j] =  I0_t(I0_0, x[i*100+j], NEH) +rnorm(1,0,0.005) ; # I0_t(I0_0, x[i*100+j], NEH); # data$I0.11[i];# 
      
      I1[i*100+j] =  I1_t(I0_0, I1_0, NEH, x[i*100+j])+rnorm(1,0,0.005) ; #I1_t(I0_0, I1_0, NEH, x[i*100+j]); #data$I1.11[i];#
      
      I2[i*100+j] =  I2_t(I0_0, I1_0, I2_0, x[i*100+j], NEH)+rnorm(1,0,0.005); #I2_t(I0_0, I1_0, I2_0, x[i*100+j], NEH); # data$I2.11[i];#
  ...
  df <- data.frame(pep[101:length(a)],
                   ...
                   I0[101:length(a)], I1[101:length(a)], I2[101:length(a)]
  )
  
  write.csv(df, "sim_all_noise.csv", row.names = FALSE)
  print('done!')
